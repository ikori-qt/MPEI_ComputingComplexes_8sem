...
public class Main {
    public static void main () throws IOException {
        ...
        CircuitData dataCircTwo = mapper.readValue(Files.readString(Path.of("assignmentThree/src/main/java/electricalGraphTwo.json")), CircuitData.class);
        dataCircTwo.startComputing();
